  ...
  )
{
  ...
  //TODO: init manufacturer_data, service_data and data
...
static void advertisement_get_manufacturer_data(void *advertisement_ptr, DBusMessageIter *iter)
{
  ...
  dbusutils_iter_append_dict_entry_fixed_array(
    ...
    DBUS_TYPE_BYTE, 
    &advertisement->manufacturer_data.data.data, 
    &advertisement->manufacturer_data.data.length
  );
...
static void advertisement_get_service_data(void *advertisement_ptr, DBusMessageIter *iter)
{
  ...
  dbusutils_iter_append_dict_entry_fixed_array(
    ...
    DBUS_TYPE_BYTE, 
    &advertisement->service_data.data.data, 
    &advertisement->service_data.data.length
  );
...
static void advertisement_get_data(void *advertisement_ptr, DBusMessageIter *iter)
{
  ...
  dbusutils_iter_append_dict_entry_fixed_array(
    ...
    DBUS_TYPE_BYTE, 
    &advertisement->data.data.data, 
    &advertisement->data.data.length
  );
...
static void advertisement_get_includes(void *advertisement_ptr, DBusMessageIter *iter)
{
  ...
  dbus_message_iter_append_basic (iter, DBUS_TYPE_STRING, &tx_power);
  dbus_message_iter_append_basic (iter, DBUS_TYPE_STRING, &appearance);
  dbus_message_iter_append_basic (iter, DBUS_TYPE_STRING, &local_name);
